...
BOARD_KERNEL_CMDLINE += androidboot.hab.csv=1 androidboot.hab.product=channel androidboot.hab.cid=50 androidboot.selinux=permissive
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 2466250752    #  2818048 * 1024 mmcblk0p62-63
#BOARD_USERDATAIMAGE_PARTITION_SIZE := 24540855808 # 22622191 * 1024 mmcblk0p64
